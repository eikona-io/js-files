...
export function createBanner(divElement, options = {}) {
  ...
  switch (shape) {
    ...
    case 'centered':
      clipPath = '';
      textContainerStyle = { top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: '90%', height: '100%' };
      break;
    case 'aligned-left':
      clipPath = '';
    ...
    case 'bottom-center':
      clipPath = '';
      textContainerStyle = { top: '80%', left: '50%', transform: 'translate(-50%, -50%)', width: '90%', height: '100%' };
      break;
    case 'top-center':
      clipPath = '';
      textContainerStyle = { top: '20%', left: '50%', transform: 'translate(-50%, -50%)', width: '90%', height: '100%' };
      break;
    default:
      clipPath = '';
  }
